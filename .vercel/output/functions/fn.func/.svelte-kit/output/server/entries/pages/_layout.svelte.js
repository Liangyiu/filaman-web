  ...
  return ` ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    header: () => {
      return ` ${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        trail: () => {
          return `<a class="btn btn-sm variant-ghost-surface" href="https://www.umwelt-campus.de/forschung/projekte/innovationslabor-digitalisierung-innodig" target="_blank" rel="noreferrer" data-svelte-h="svelte-iq7f0i">Innodig</a> `;
        },
        lead: () => {
          return `<strong class="text-xl uppercase" data-svelte-h="svelte-1wefp9y">Fila-Man</strong>`;
        }
      })} `;
    },
    default: () => {
